               ...
               <table class="table table-success table-hover text-center">
                   ...
                   @foreach ($entretienDemandes as $entre)
                         ...
                         <td>@if(isset($entre->demande->stagiaire->nom_stagiaire)){{$entre->demande->stagiaire->prenom_stagiaire}} &nbsp;{{$entre->demande->stagiaire->nom_stagiaire}} @endif</td>
                            ...
                            <td>@if($entre->accepter ==1) <p class="m-0 p-0">oui</p> <img src="{{asset('/pic/check.png')}}" class="m-0 p-0" width="30px" alt=""> @else attente de réponse @endif </td> 
           ...
           <div class="card-body">
               ...
               <table class="table table-primary table-hover text-center">
                   ...
                   @foreach ($entretienOffres as $dem)
                         <tr>
                         <td>{{ $dem->stagiaire->prenom_stagiaire }}&nbsp;{{ $dem->stagiaire->nom_stagiaire }}</td>
                            ...
                            <td>@if($dem->accepter ==1) <p class="m-0 p-0">oui</p> <img src="{{asset('/pic/check.png')}}" class="m-0 p-0" width="30px" alt=""> @else attente de réponse @endif </td> 
