...
<div class=" text-center d-flex align-items-center justify-content-center" style="height: 550px;width:400px; margin:auto;">
      ...
      <form action=" {{route('entreprise.offre.store')}}" method="post" style="border:1px solid black;border-radius:30px;background-color:whitesmoke;padding: 35px 25px;">
          <h4>création d'une offre de stage</h4>
