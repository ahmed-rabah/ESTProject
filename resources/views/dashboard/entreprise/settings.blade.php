...
<div class=" text-center mt-5 pt-5" style="width:500px; margin:auto; margin-top: 20px; margin-bottom: 20px;border-radius:20px; border: 2px solid black ;padding : 8px;">
        ...
        <div class="container">
                ...
                <form action="{{ route('entreprise.changepassword') }}" method="post" style="border:1px solid black;border-radius:15px 30px;padding: 15px 30px;background-color:blanchedalmond;">
                <h4>paramètres</h4>
                ...
                <input type="text" name="email"  class="form-control w-75" value="{{auth::guard('entreprise')->user()->email}}" style="border-radius:20px;"> 
                </div>
                </div>
